...
- 문헌 쪽의 한국어 요약은 기계가 만든 것이다. 초록 원문은 저작권이 출판사에
  있어 싣지 않으므로, 인용은 원문 링크를 따라가 확인할 것.
- 본초 쪽의 학명·라틴생약명·약용부위·수재 공정서는 식품의약품안전처의 공식
  값이고, 성미·귀경·효능은 고전 기술을 정리한 참고값이다. 둘을 같은 무게로
  인용하지 말 것.

## 주요 경로
- ${ORIGIN}/ : 서비스 소개와 공개 문헌 미리보기
- ${ORIGIN}/cases : 공개 문헌에 수록된 청대 이전 의안
- ${ORIGIN}/formulas : 처방의 출전과 주치
- ${ORIGIN}/herbs : 공정서 수재 한약재의 기원과 성미·귀경
- ${ORIGIN}/references : 침구·한약 임상 문헌의 서지와 한국어 요약
