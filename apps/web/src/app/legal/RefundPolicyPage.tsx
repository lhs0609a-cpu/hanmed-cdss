        ...
        <Card>
          ...
          <CardContent className="prose prose-sm max-w-none">
            ...
            <p className="text-gray-700 leading-relaxed">
              본 환불 정책은 {companyField('name')}(이하 "회사")이 제공하는 모든 유료 서비스에 적용됩니다.
            </p>
              ...
              <li>
                ...
                <div className="ml-6 mt-2 p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-sm mt-2 text-gray-600">
                    예시: 월 49,000원 결제, 10일 사용 후 환불 요청<br />
                    환불액 = 49,000 × (20/30) = 32,667원
                  </p>
                </div>
              </li>
              <li className="mt-4">
            ...
            <p className="text-gray-700">본 환불 정책은 {companyField('effectiveDate')}부터 시행합니다.</p>
