          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="px-5 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-blue-500/30 transition-all"
              >
                무료 체험
              </button>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                <span className="text-blue-600">40년 임상 경험</span>이<br />
                당신의 진료실에
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={handleStartTrial}
                  className="group px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-lg font-bold rounded-2xl hover:shadow-2xl hover:shadow-blue-500/30 transition-all flex items-center justify-center gap-2"
                >
                  14일 무료 체험 시작
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
                <div className="bg-gradient-to-r from-blue-500 to-blue-600 h-12 flex items-center px-4 gap-2">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="font-semibold text-blue-800">AI 추천 처방</span>
                      <span className="ml-auto px-2 py-0.5 bg-blue-500 text-white text-xs font-bold rounded">95% 일치</span>
                    </div>
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {/* After */}
            <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-3xl p-8">
              <div className="flex items-center gap-3 mb-6">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
              ...
              <div className="p-8">
                ...
                <button
                  onClick={handleStartTrial}
                  className="w-full py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-lg font-bold rounded-2xl hover:shadow-xl hover:shadow-blue-500/30 transition-all"
                >
                  14일 무료 체험 시작하기
                </button>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 to-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <button
              onClick={handleStartTrial}
              className="group px-8 py-4 bg-white text-blue-600 text-lg font-bold rounded-2xl hover:shadow-2xl transition-all flex items-center justify-center gap-2"
            >
              14일 무료 체험 시작
              <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
            </button>
