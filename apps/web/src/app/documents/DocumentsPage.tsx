...
추나요법은 한의사가 손 또는 신체의 일부분을 이용하거나 추나 테이블 등의
보조기구를 이용하여 환자의 신체 구조에 유효한 자극을 가하여 구조적,
기능적 문제를 치료하는 한방 수기요법입니다.
...
1. 본인은 위 추나요법에 대한 설명을 충분히 듣고 이해하였습니다.
2. 발생 가능한 이상반응에 대해 설명을 들었습니다.
3. 시술 중 통증이나 이상 증상 발생 시 즉시 알리겠습니다.
4. 위 금기사항에 해당되는 경우 시술 전 반드시 알려야 함을 이해합니다.
5. 본인은 자발적으로 추나요법 시술에 동의합니다.
...
담당 한의사: ____________ (서명)

* 본 동의서는 건강보험 요양급여 청구 시 필요한 필수 서류입니다.
`

const acupunctureInfoContent = `
침치료 후 안내문

환자명: ____________님

오늘 침치료를 받으셨습니다.
다음 사항을 참고하시어 치료 효과를 높이시기 바랍니다.
...
1. 자침 부위 관리
   • 치료 후 2~3시간은 해당 부위를 만지지 마세요
   • 자침 부위에 물이 닿아도 괜찮습니다
   • 가벼운 멍이나 붉은 자국은 자연스럽게 사라집니다
...
3. 음식
   • 차가운 음식, 날음식은 피하세요
   • 자극적인 음식(맵고 짠 것)은 피하세요
   • 소화가 잘 되는 따뜻한 음식이 좋습니다
...
다음 증상은 치료 반응으로 자연스럽게 사라집니다:
   • 자침 부위 가벼운 통증, 뻐근함
   • 나른함, 졸음
   • 시술 부위 가벼운 멍 (2~3일 내 소실)
   • 일시적 증상 악화 후 호전 (명현반응)
...
[다음과 같은 경우 즉시 연락하세요]
   ...
   • 시술 부위 심한 통증, 부종이 지속될 때
   • 출혈이 멈추지 않을 때
   • 고열이 발생할 때
   • 호흡 곤란, 두근거림이 있을 때
   • 기타 평소와 다른 이상 증상이 있을 때
...
환자명: ____________          차트번호: ____________
생년월일: ____________        성별: □ 남  □ 여
기록일자: ____________        작성자: ____________
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[현재 증상 (Present Status)]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

1. 주증상 강도 (VAS 0-10): ______ / 10
...
4. 수면: □ 양호  □ 불량 (____________)

5. 식욕/소화: □ 양호  □ 불량 (____________)

6. 대변: □ 정상  □ 변비  □ 설사  (____회/일)

7. 소변: □ 정상  □ 빈뇨  □ 야간뇨 (____회)
...
4. 다음 내원 예정일: ____________

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

담당 한의사: ____________ (서명)

기록일시: ______년 ____월 ____일 ____:____
`
  ...
  const getPreviewContent = () => {
    ...
    switch (selectedTemplate.id) {
      ...
      case 'consent-herbal':
        ...
        break
      case 'consent-chuna':
        content = chunaConsentContent
        break
      case 'info-herbal':
        content = herbalInfoContent
        break
      case 'info-acupuncture':
        content = acupunctureInfoContent
        break
      case 'progress-note':
